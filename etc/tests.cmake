...
add_custom_target (check_lab3 COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --timeout 10 -R 't_webget|t_byte_stream|_dt'
                              COMMENT "Testing ByteStream...")
add_custom_target (check_lab4 COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --timeout 10 -R '^arp_|^router_'
                              COMMENT "Testing ARP & Rounter...")
add_custom_target (check_lab5 COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --timeout 10 -R 't_send_|t_recv_|t_wrapping_|t_strm_reassem_|t_byte_stream|_dt'
                              COMMENT "Testing TCP receiver & TCP sender...")
add_custom_target (check_lab6 COMMAND "${PROJECT_SOURCE_DIR}/tun.sh" check 144 145
                                COMMAND "${PROJECT_SOURCE_DIR}/tap.sh" check 10
                                COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --timeout 10 -R '^t_'
                                COMMENT "Testing TCPConnection...")